...
# Open "Moba" with its own dedicated sessions.
PROJ="Moba"
DRIVE="/run/media/hubertg/SONIC"
DATA="/run/media/hubertg/SONIC/OpenCodeBox/project-data/Moba/.opencode-data"
SESSIONS_DIR="/run/media/hubertg/SONIC/OpenCodeBox/project-data/Moba/sessions"
...
export OPENCODE_CONFIG="/run/media/hubertg/SONIC/OpenCodeBox/project-data/Moba/opencode.json"
